...
resource "oci_limits_quota" "iaas_restrictions" {
  ...
  statements = [
    # Compute and related
    "zero compute-core quotas in compartment IaaS-Root",
    "zero compute-memory quotas in compartment IaaS-Root",
    "zero compute quotas in compartment IaaS-Root",
    "zero compute-management quotas in compartment IaaS-Root",
    "zero auto-scaling quotas in compartment IaaS-Root",
    "zero container-engine quotas in compartment IaaS-Root",
    "zero cluster-placement-groups quotas in compartment IaaS-Root",
    
    # Storage
    "zero block-storage quotas in compartment IaaS-Root",
    "zero object-storage quotas in compartment IaaS-Root",
    "zero filesystem quotas in compartment IaaS-Root",
    "zero lustrefilestorage quotas in compartment IaaS-Root",
    
    # Database
    "zero database quotas in compartment IaaS-Root",
    "zero nosql quotas in compartment IaaS-Root",
    "zero postgresql quotas in compartment IaaS-Root",
    "zero database-migration quotas in compartment IaaS-Root",
    
    # Networking
    "zero vcn quotas in compartment IaaS-Root",
    "zero load-balancer quotas in compartment IaaS-Root",
    "zero network-load-balancer-api quotas in compartment IaaS-Root",
    "zero network-firewall quotas in compartment IaaS-Root",
    "zero fast-connect quotas in compartment IaaS-Root",
    "zero vpn quotas in compartment IaaS-Root",
    "zero dns quotas in compartment IaaS-Root",
    "zero network-path-analyzer quotas in compartment IaaS-Root",
    
    # AI/ML Services
    "zero ai-anomaly-detection quotas in compartment IaaS-Root",
    "zero ai-document quotas in compartment IaaS-Root",
    "zero ai-forecasting quotas in compartment IaaS-Root",
    "zero ai-vision quotas in compartment IaaS-Root",
    "zero ai-language quotas in compartment IaaS-Root",
    "zero ai-speech quotas in compartment IaaS-Root",
    "zero data-science quotas in compartment IaaS-Root",
    "zero data-labeling quotas in compartment IaaS-Root",
    
    # Analytics and Data
    "zero analytics quotas in compartment IaaS-Root",
    "zero data-catalog quotas in compartment IaaS-Root",
    "zero data-flow quotas in compartment IaaS-Root",
    "zero data-integration quotas in compartment IaaS-Root",
    "zero big-data quotas in compartment IaaS-Root",
    "zero streaming quotas in compartment IaaS-Root",
    "zero oci-kafka quotas in compartment IaaS-Root",
    "zero goldengate quotas in compartment IaaS-Root",
    
    # Application Services
    "zero api-gateway quotas in compartment IaaS-Root",
    "zero faas quotas in compartment IaaS-Root",
    "zero integration quotas in compartment IaaS-Root",
    "zero process-automation quotas in compartment IaaS-Root",
    "zero digital-assistant quotas in compartment IaaS-Root",
    "zero visualbuilder quotas in compartment IaaS-Root",
    
    # Management and Monitoring
    "zero operations-insights quotas in compartment IaaS-Root",
    "zero logging quotas in compartment IaaS-Root",
    "zero management-agent quotas in compartment IaaS-Root",
    "zero stack-monitoring quotas in compartment IaaS-Root",
    "zero apm quotas in compartment IaaS-Root",
    "zero resource-manager quotas in compartment IaaS-Root",
    
    # Security (not needed in SaaS compartments)
    "zero cloudguard quotas in compartment IaaS-Root",
    "zero vulnerability-scanning quotas in compartment IaaS-Root",
    "zero waf quotas in compartment IaaS-Root",
    "zero waas quotas in compartment IaaS-Root",
    "zero kms quotas in compartment IaaS-Root",
    
    # Other services
    "zero devops quotas in compartment IaaS-Root",
    "zero email-delivery quotas in compartment IaaS-Root",
    "zero notifications quotas in compartment IaaS-Root",
    "zero events quotas in compartment IaaS-Root",
    "zero service-connector-hub quotas in compartment IaaS-Root",
    "zero queue quotas in compartment IaaS-Root",
    "zero blockchain quotas in compartment IaaS-Root",
    "zero redis quotas in compartment IaaS-Root",
  ]
}
